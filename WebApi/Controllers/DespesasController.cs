...
namespace WebApi.Controllers
{
    ...
    public class DespesasController : ControllerBase
    {
        ...
        private readonly IDespesaService _IDespesaServico;
        public DespesasController(InterfaceDespesa InterfaceDespesa, IDespesaService IDespesaServico)
        {
        ...
        {
            await _IDespesaServico.AtualizarDepesa(despesa);
